        ...
        <section className="py-12 bg-gray-50">
            <div className="container mx-auto px-4">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        ...
                        <div className="p-6">
                            ...
                            <Link
                                ...
                                className="inline-flex items-center mt-6 text-[#0A5C36] font-semibold hover:text-[#0a7c46] transition-colors"
                            >
                                View Full Resource
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <Link
                                            ...
                                            className="inline-block mt-3 text-[#0A5C36] text-xs font-medium hover:text-[#0a7c46] transition-colors"
                                        >
                                            Learn More →
                                        </Link>
                                    </div>
                ...
                <div className="text-center mt-8">
                    <Link
                        href="/resources"
                        className="inline-flex items-center bg-[#0A5C36] text-white px-6 py-3 rounded-tl-xl rounded-br-xl hover:bg-[#0a7c46] transition-colors font-semibold"
                    >
                        View All Resources
