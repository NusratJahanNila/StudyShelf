...
const CallToAction = () => {
  return (
    <section className="py-5 bg-linear-to-br from-[#0A5C36]/10 via-white to-[#ff7400]/10 ">
      {/* Background Layer */}
              ...
              <div className="max-w-6xl mx-auto">
                <div className="relative  ">
                  ...
                  <div className="flex justify-center">
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-linear-to-r from-[#0A5C36]/10 to-[#ff7400]/10 mb-6 justify-center">
                      <Sparkles className="h-4 w-4 text-[#0A5C36] mr-2" />
                      <span className="text-sm font-semibold text-[#0A5C36] text-center">Limited Time Offer</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <Link
                      href="/login"
                      className="group bg-[#0A5C36] text-white px-8 py-5 rounded-tl-xl rounded-br-xl hover:bg-[#0a7c46] transition-all duration-300 hover:shadow-2xl transform hover:-translate-y-1 flex flex-col items-center justify-center"
                    >
                    ...
                    <Link
                      href="/resources"
                      className="group border-2 border-gray-300 text-gray-700 px-8 py-5 rounded-tl-xl rounded-br-xl hover:border-[#0A5C36] hover:text-[#0A5C36] transition-all duration-300 hover:shadow-lg flex items-center justify-center"
                    >
                      <span className="font-semibold text-lg">Browse Resources First</span>
                    </Link>
                  </div>
