            ...
            <div className="flex space-x-4">
              {[
                ...
                <a
                  ...
                  className="bg-white p-2 rounded-lg border border-gray-200 text-gray-600 hover:text-[#0A5C36] hover:border-[#0A5C36] transition-all duration-300 hover:shadow-md"
                >
              ...
              <ul className="space-y-2">
                {links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="flex items-center text-gray-600 hover:text-[#0A5C36] transition-colors duration-300 group"
                    >
