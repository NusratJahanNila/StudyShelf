        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="border-b border-gray-200 py-4">
                <div className="container mx-auto px-4">
                    <Link
                        href="/resources"
                        className="inline-flex items-center text-gray-600 hover:text-[#0A5C36] transition-colors"
                    >
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        {/* Title & Category */}
                        <div className="mb-6">
                            <div className="inline-flex items-center px-4 py-2 bg-[#0A5C36]/10 text-[#0A5C36] rounded-full text-sm font-semibold mb-4">
                                {resource.category}
                            </div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-2xl border border-gray-200 p-6 sticky top-8">
                            {/* Price & Actions */}
                            <div className="mb-6">
                                <div className={`text-center py-3 rounded-tl-xl rounded-br-xl text-xl font-bold mb-4 ${
                                    isFree 
                                ...
                                <div className="flex gap-3">
                                    <button className="flex-1 bg-[#0A5C36] text-white py-3 rounded-tl-xl rounded-br-xl hover:bg-[#0a7c46] transition-colors font-semibold">
                                        {isFree ? 'Download Now' : 'Get Access'}
                                    </button>
                                    <button className="p-3 border border-gray-300 rounded-xl hover:border-gray-400 transition-colors">
                            ...
                            <div className="pt-6 border-t border-gray-200">
                                ...
                                <ul className="space-y-2">
                                    <li className="flex items-center text-gray-600">
                                        <CheckCircle className="h-5 w-5 text-[#0A5C36] mr-2" />
